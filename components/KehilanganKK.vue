...
export default {
    ...
    methods: {
        ...
        setuju(val) {
            ...
            this.$swal.fire({
                ...
                preConfirm: (hapus) => {
                    ...
                    fd.append('status', '1')
                    return this.$axios.$put(`/kehilangan-kk/status/${kk.id}`, fd)
                        .then(res => {
                            console.log(res)
                        })
                        .catch(err => {
        ...
        async cetak(id) {
            const data = await this.$axios.$get(`/kehilangan-kk/${id}`)
            ...
            doc.text(':', 60, 173)
            doc.text("Bahwa yang bersangkutan telah kehilangan Kartu Keluarga", 62, 173)
