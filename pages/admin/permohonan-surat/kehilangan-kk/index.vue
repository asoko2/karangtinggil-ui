<template>
    <v-col cols="12">
        <v-btn color="secondary" to="/admin/permohonan-surat/kehilangan-kk/tambah">
            <v-icon>mdi-plus-thick</v-icon>Tambah Kehilangan KK
        </v-btn>
        <v-card>
            <v-toolbar flat>
                ...
                <v-col cols="12">
                    <v-data-table :headers="headers" :items="kks" disable-pagination :options.sync="options"
                        ...
                        <template v-slot:[`item.actions`]="{ item }">
                            <router-link :to="'/admin/permohonan-surat/kehilangan-kk/' + item.id" class="primary--text"
